...
async def play(_, message: Message):
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**Innexia Music assistant joined this group for play music 🎵**")
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/c5dc411ba61ae395a625b.jpg"
        ...
        try:
            ...
            title = "NaN"
            thumb_name = "https://telegra.ph/file/8410357fed401ee83ff14.jpg"
            duration = "NaN"
            views = "NaN"
            keyboard = InlineKeyboardMarkup(
                    [
